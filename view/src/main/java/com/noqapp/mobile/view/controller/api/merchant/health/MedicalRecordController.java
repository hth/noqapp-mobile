...
import static com.noqapp.common.errors.MobileSystemErrorCodeEnum.MEDICAL_RECORD_POPULATED_WITH_LAB;
...
public class MedicalRecordController {
    ...
    public String historical(
        ...
        try {
            ...
            return medicalRecordService.populateMedicalHistoryForDoctor(findMedicalProfile.getQueueUserId()).asJson();
        } catch (Exception e) {
