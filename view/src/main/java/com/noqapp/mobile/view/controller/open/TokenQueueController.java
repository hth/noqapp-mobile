...
public class TokenQueueController {
    ...
    public String getAllQueueState(
        ...
        try {
            return tokenQueueMobileService.findAllBizStoreByBizNameCodeQRSet(codeQR.getText()).asJson();
        } catch (Exception e) {
    ...
    public String levelUp(
        ...
        try {
            ...
            return tokenQueueMobileService.findAllBizStoreByBizNameCodeQRList(bizStore.getBizName().getCodeQR()).asJson();
        } catch (Exception e) {
            LOG.error("Failed getting all queue state did={} reason={}", did, e.getLocalizedMessage(), e);
            apiHealthService.insert(
                    "/levelUp/{codeQR}",
