...
@RestController
@RequestMapping(value = "/api/m/preference")
public class MerchantPreferenceController {
    private static final Logger LOG = LoggerFactory.getLogger(com.noqapp.mobile.view.controller.api.client.ClientPreferenceController.class);
    ...
    @Autowired
    public MerchantPreferenceController(
    ...
    public String notificationSound(
        ...
        try {
            ...
            apiHealthService.insert(
                "/notificationSound",
                "notificationSound",
                com.noqapp.mobile.view.controller.api.client.ClientPreferenceController.class.getName(),
