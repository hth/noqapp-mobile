...
<div class="email-style"
    ...
    <div class="content-txt" style="font-size:16px; padding:0 15px; font-family: 'Roboto', sans-serif;">
        ...
        <p style="padding-bottom:10px; font-family: 'Roboto', sans-serif;">
            Login credential for Store Manager is ${login} & password is ${password}. Please save this email for future. This
            is the only time you would receive this email with login credential.
        </p>
        <p style="padding-bottom:10px; font-family: 'Roboto', sans-serif;">
            Use this credential for login in NoQueue Business or Website <a href="https://q.noqapp.com" style="padding:8px 15px; background:#ff1c79; color:#fff; text-decoration: none">Web Login Here</a>
        </p>
        <p style="padding-bottom:10px; font-family: 'Roboto', sans-serif;">
