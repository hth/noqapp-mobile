...
public enum LowestSupportedAppEnum {
    ...
    VACL("1.2.150",                     //Oldest Supported App Version in String
        ...
        AppFlavorEnum.NQCL,
        "1.2.191",                      //Latest App Version on Play Store
    ...
    VAMS("1.2.190",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMS,
        "1.2.191",                      //Latest App Version on Play Store
        "Version Android Merchant Store"),

    VAMH("1.2.190",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMH,
        "1.2.191",                      //Latest App Version on Play Store
        "Version Android Merchant HealthCare"),

    VAMT("1.2.190",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMT,
        "1.2.191",                      //Latest App Version on Play Store
