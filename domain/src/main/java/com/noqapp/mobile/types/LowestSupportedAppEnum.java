...
public enum LowestSupportedAppEnum {
    ...
    VACL("1.2.542",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQCL,
        "1.2.546",                      //Latest App Version on Play Store
        "Version Android Client"),

    VACH("1.2.546",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQCH,
        "1.2.546",                      //Latest App Version on Play Store
        "Version Android Client HealthCare"),

    VAMS("1.2.529",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMS,
        "1.2.529",                      //Latest App Version on Play Store
        "Version Android Business Store"),

    VAMH("1.2.533",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMH,
        "1.2.533",                      //Latest App Version on Play Store
        "Version Android Business HealthCare"),

    VAMT("1.2.529",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMT,
        "1.2.529",                      //Latest App Version on Play Store
        "Version Android Business TV"),

    VAMI("1.2.529",                     //Oldest Supported App Version in String
        DeviceTypeEnum.A,                               //Device Type
        AppFlavorEnum.NQMI,
        "1.2.529",                      //Latest App Version on Play Store
